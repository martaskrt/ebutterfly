...
class AttentionModule_stage0(nn.Module):
    ...
    def forward(self, x):
        ...
        return out_last, out_softmax8


class AttentionModule_stage1(nn.Module):
    # input size is 56*56
    def __init__(self, in_channels, out_channels, size1=(56, 56),
                 size2=(28, 28), size3=(14, 14)):
...
class ResidualAttentionModel_448input(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.attention_module3_2 = AttentionModule_stage3(
            1024, 1024)  # tbq add
        self.attention_module3_3 = AttentionModule_stage3(
            1024, 1024)  # tbq add
    ...
    def forward(self, x):
        ...
        out, attention_mask = self.attention_module0(out)
        masks.append(attention_mask)
        # print(out.data)
        out = self.residual_block1(out)
        out, attention_mask = self.attention_module1(out)
        masks.append(attention_mask)
        out = self.residual_block2(out)
        out, attention_mask = self.attention_module2(out)
        masks.append(attention_mask)
        out, attention_mask = self.attention_module2_2(out)
        masks.append(attention_mask)
        out = self.residual_block3(out)
        # print(out.data)
        out, attention_mask = self.attention_module3(out)
        masks.append(attention_mask)
        out, attention_mask = self.attention_module3_2(out)
        masks.append(attention_mask)
        out, attention_mask = self.attention_module3_3(out)
        masks.append(attention_mask)
